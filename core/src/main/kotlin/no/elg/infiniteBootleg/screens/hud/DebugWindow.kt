...
class DebugWindow(
  ...
  private val debugWindows: List<KVisWindow>
) {

  val isDebugMenuVisible: Boolean get() = debugWindows.any { it.isVisible || it.isShown() }
...
fun Stage.addDebugOverlay(world: ClientWorld): DebugWindow {
  actors {
    val debugWindows = mutableListOf<KVisWindow>()
