...
public class PerlinNoise {
  ...
  /**
   * <a href="https://gist.github.com/Flafla2/f0260a861be0ebdeef76">All credits for this goes to
   * Flafla2</a>
   *
   * @param x x coordinate
   * @param y y coordinate
   * @param z z coordinate
   * @param octaves How refined the result should be
   * @param persistence How different each octave is
   ...
   * @param y y coordinate
   * @param z z coordinate
   * @param amplitude How far it goes up and down (think wave amplitude)
