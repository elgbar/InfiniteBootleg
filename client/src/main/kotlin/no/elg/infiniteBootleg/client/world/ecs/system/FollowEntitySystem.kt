...
object FollowEntitySystem : FamilyEntitySystem(followEntityFamily, UPDATE_PRIORITY_EARLY) {
  ...
  private fun processEntity(entity: Entity, deltaTime: Float) {
    ...
    if (worldRender is ClientWorldRender) {
      ...
      val x = position.x * Block.BLOCK_TEXTURE_SIZE
      val y = position.y * Block.BLOCK_TEXTURE_SIZE
