...
class MouseLocator {
  ...
  val mouseBlockCompactLoc: WorldCompactLoc get() = compactInt(mouseBlockX, mouseBlockY)
  ...
  fun update(world: ClientWorld) {
    ...
    if (screenInputVec.z == 0f) {
      ...
      mouseWorldX = screenInputVec.x / Block.BLOCK_TEXTURE_SIZE
      mouseWorldY = screenInputVec.y / Block.BLOCK_TEXTURE_SIZE
